...
# build files
TARGET = main.cpp data/Point.cpp data/Vector.cpp testing/Point_unittest.cpp testing/Vector_unittest.cpp algo/GeometryOps_2.cpp testing/GeometryOps_2_unittest.cpp data/PolyLine.cpp testing/PolyLine_unittest.cpp
